...
<!-- TODO: Add Calendly booking link here when ready
<div style="margin-top: 2rem;">
  <h3>Book a Call</h3>
  <p>Schedule a 15-minute intro call to discuss opportunities:</p>
  <a href="https://calendly.com/kademedley" class="btn btn-primary" target="_blank" rel="noopener">
    📅 Book on Calendly
  </a>
</div>
-->

<p class="contact-location" style="margin-top: 2rem;">
  📍 Relocating to Prague/Brno
</p>

<p class="work-auth-notice" style="margin-top: 1.5rem;">
  Non-EU citizen — will require Employment Card sponsorship. Ready to proceed quickly with documentation.
</p>
